...
/* Drawing Set preview: navigation behaves like a pinned sheet index. */
.ccgl-contents-layer {
...
.ccgl-contents-trigger {
  ...
  box-shadow: 6px 6px 0 rgba(36, 75, 115, 0.08);
  color: #244b73;
...
.ccgl-contents-panel footer kbd {
  ...
  background: transparent;
  color: inherit;
  font: 700 10px/1 "SFMono-Regular", Consolas, "Liberation Mono", monospace;
}
...
.ccgl-contents-backdrop {
  padding: 22px;
  background:
    repeating-linear-gradient(135deg, rgba(36, 75, 115, 0.09) 0 1px, transparent 1px 10px),
    rgba(17, 39, 59, 0.64);
...
.ccgl-contents-panel {
  ...
  border-radius: 0;
  background:
    linear-gradient(90deg, transparent 35px, rgba(183, 72, 63, 0.3) 36px, transparent 37px),
    repeating-linear-gradient(0deg, transparent 0 31px, rgba(36, 75, 115, 0.055) 31px 32px),
    #f4f0e7;
  box-shadow: 12px 12px 0 rgba(9, 24, 36, 0.26);
  color: #244b73;
}

.ccgl-contents-header {
  padding: 32px 36px 23px 56px;
...
.ccgl-contents-item {
  ...
  min-height: 88px;
  padding: 14px 16px;
  border-bottom: 1px solid rgba(36, 75, 115, 0.28);
}

.ccgl-contents-item:hover {
  background:
    repeating-linear-gradient(135deg, rgba(36, 75, 115, 0.06) 0 7px, transparent 7px 14px);
}

.ccgl-contents-item.active {
  border-left: 4px solid #b7483f;
  background: rgba(183, 72, 63, 0.07);
}
