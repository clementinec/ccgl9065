...
## One Image. One Speech.

::: {style="font-size: 1.6em; text-align: center; padding: 50px; background: #0a3d62; color: white; border-radius: 15px; line-height: 1.8;"}
...
[**The water was up to his knees.**]{style="color: #e74c3c; font-size: 1.3em;"}

He was standing where dry land used to be.
:::

::: {style="font-size: 1.4em; text-align: center; margin-top: 20px;"}
{{< video https://www.youtube.com/embed/jBBsv0QyscE width="1600" height="900" >}}
:::
