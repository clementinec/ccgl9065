---
title: "[Archive] CCGL9065 Tutorial 1: Climate Data Science"
search: false
format: 
  revealjs: 
    slide-number: c/t
...
## Archived tutorial model

This deck is retained as a record of an earlier Arduino and climate-data tutorial.

It is **not the current tutorial format**. Current tutorials are paired work sessions in which students complete weekly work, compare evidence, and prepare for the next class.
